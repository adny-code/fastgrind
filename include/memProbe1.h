...
/*
 * Maximum stack depth for call stacks.
 * This is used to limit the size of the call stack array.
 */
    ...
    void dump() const
    {
        ...
        for (auto &[tid, threadsInfo] : _frames)
        {
            for (auto &[frameId, tickInfo] : threadsInfo)
            {
                ...
                printf("  %u: threadId:%lu %s: alloc %lu free %lu\n", count++, tid, getCallstack(frameId).c_str(),
                       frame0.mallocBytes, frame0.freeBytes);
            }
        }
...
static std::vector<void *> memFuncTable = {(void *)&__wrap_malloc,  (void *)&__wrap_free,    (void *)&__wrap__Znwm,
                                           (void *)&__wrap__Znam,   (void *)&__wrap__ZdlPv,  (void *)&__wrap__ZdaPv,
                                           (void *)&__wrap__ZdaPvm, (void *)&__wrap__ZdlPvm, nullptr};
...
static std::vector<void *> memFuncTable = {(void *)&malloc, (void *)&free, nullptr};
#endif

...
#include <gperftools/tcmalloc.h>
    ...
    extern void *tc_calloc(size_t, size_t);
    extern void *tc_realloc(void *, size_t);
    extern void tc_free(void *);
    extern void *tc_memalign(size_t, size_t);
    extern void *tc_valloc(size_t);
    extern void *tc_pvalloc(size_t);
    extern int tc_posix_memalign(void **, size_t, size_t);
    extern void *tc_reallocf(void *, size_t);
    extern void *tc_recalloc(void *, size_t, size_t);
    extern void *tc_new_aligned(size_t, std::align_val_t);
    extern void *tc_new_aligned_nothrow(size_t, std::align_val_t, const std::nothrow_t &);
    extern void tc_delete_aligned(void *, std::align_val_t);
    extern void tc_delete_sized_aligned(void *, size_t, std::align_val_t);
    extern void tc_delete_aligned_nothrow(void *, std::align_val_t, const std::nothrow_t &);
    extern void tc_deletearray_aligned(void *, std::align_val_t);
    extern void tc_deletearray_sized_aligned(void *, size_t, std::align_val_t);
    extern void tc_free_sized(void *, size_t);
    extern void tc_free_sized_aligned(void *, size_t, std::align_val_t);
    extern void tc_free_aligned(void *, std::align_val_t);
    extern void tc_free_sized_aligned_nothrow(void *, size_t, std::align_val_t, const std::nothrow_t &);
    extern void tc_free_aligned_nothrow(void *, std::align_val_t, const std::nothrow_t &);
...
#include <jemalloc/jemalloc.h>
    ...
    extern void *je_new_aligned(size_t, std::align_val_t);
    extern void *je_new_aligned_nothrow(size_t, std::align_val_t, const std::nothrow_t &);
    extern void je_delete_aligned(void *, std::align_val_t);
    extern void je_delete_sized_aligned(void *, size_t, std::align_val_t);
    extern void je_delete_aligned_nothrow(void *, std::align_val_t, const std::nothrow_t &);
    extern void je_deletearray_aligned(void *, std::align_val_t);
    extern void je_deletearray_sized_aligned(void *, size_t, std::align_val_t);
    extern void je_free_sized(void *, size_t);
    extern void je_free_sized_aligned(void *, size_t, std::align_val_t);
    extern void je_free_aligned(void *, std::align_val_t);
    extern void je_free_sized_aligned_nothrow(void *, size_t, std::align_val_t, const std::nothrow_t &);
    extern void je_free_aligned_nothrow(void *, std::align_val_t, const std::nothrow_t &);
